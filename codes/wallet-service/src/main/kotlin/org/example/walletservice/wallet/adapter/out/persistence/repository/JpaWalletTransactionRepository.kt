...
class JpaWalletTransactionRepository(
    ...
    private val japWalletTransactionMapper: JpaWalletTransactionMapper,
    ...
    override fun save(walletTransactions: List<WalletTransaction>) {
        springDataJpaWalletTransactionRepository.saveAll(walletTransactions.map { japWalletTransactionMapper.mapToJpaEntity(it) })
    }
}
